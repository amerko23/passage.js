...
app.post('/sale-api', async (req, res) => {
  try {
    const { txn_type, token, amount, surchargeIndicator, surchargeAmount, phone, address1, address2, city, state, shipping_country, billing_country, zip, email, customer_sms, merchant_email } = req.body;
